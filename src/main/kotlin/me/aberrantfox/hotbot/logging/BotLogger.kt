...
interface BotLogger {
    ...
    fun warning(message: MessageEmbed)
...
class DefaultLogger : BotLogger {
    ...
    override fun warning(message: MessageEmbed) {}
...
class ChannelLogger(private val channels: Channels) : BotLogger {
    ...
    override fun warning(message: MessageEmbed) = channels.warning.sendMessage(message).queue()
